...
export const LitRpgBlock = Node.create({
  ...
  addAttributes() {
    return {
      ...
      showCellBorders: { default: true, parseHTML: (element) => element.getAttribute('data-show-cell-borders') !== 'false' },
  ...
  renderHTML: ({ node, HTMLAttributes }) => {
    ...
    return [
      ...
      mergeAttributes(HTMLAttributes, {
        ...
        'data-show-cell-borders': String(node.attrs.showCellBorders),
